...
Welcome to `dotenvhub` contributor's guide.
...
If you experience bugs or general issues with `dotenvhub`, please have a look
...
You can help improve `dotenvhub` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dotenvhub` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dotenvhub`'s files. While this mechanism can
...
```
conda create -n dotenvhub python=3 six virtualenv pytest pytest-cov
conda activate dotenvhub
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dotenvhub.git
   cd dotenvhub
   ```
...
5. Install [pre-commit]:
   ...
   `dotenvhub` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dotenvhub
[issue tracker]: https://github.com/<USERNAME>/dotenvhub/issues
